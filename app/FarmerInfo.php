...
/**
 * Description of FarmerInfo
 *
 * @author Nat
 */
class FarmerInfo extends KdmBaseModel{
    //put your code here
    ...
    protected $fillable = [
        ...
        'registered_capital', 'corporate_type_id', 'remark','age','house_number','village','village_number','alley'
    ];
