...
/**
 * Description of InvestorInfo
 *
 * @author Tae
 */
class InvestorInfo extends KdmBaseModel{
    //put your code here
    ...
    protected $fillable = [
        ...
        'registered_capital', 'corporate_type_id','age','house_number','village','village_number','alley','affiliation'
    ];
